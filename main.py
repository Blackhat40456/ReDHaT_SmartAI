...
MAX_USER_MSG = 20
REDHAT_SESSION = "BQFYoXsAiNIscviw8Ce0diJTEAumWpW0fBxZllcBN_BpDX_BdpgkQpThNH_lp3kBM9wHMoRt4R5FzHG41vjK7CBg4B0u3o2lft-nNPXoOWsgyZ59-i96Z8cviSutyUbBkBbnwMQs6BQf2tHC_tvorucv-LBF97nKTMQTEGASojIlLRk9aJfr5KQzxqJExkV87hoBvbNfsVz1zayFHqDa1dO0xmeLOYYiS9jSsYVK2WpQ5w13lCTO3KKDW0psBPIuZFUy4o8hwHJOw2JTzi6DSDuON9S7CFVR8ZmXrnWsYWQFloCEW3yr4dYB2a0bUFUfPifcZgB5TaC8egwYvSXVXPe9dUNG-gAAAAFXwLNAAA"
...
async def handle_user_message(client: Client, message: MessageType):
    ...
    await asyncio.sleep(random.randint(60, 100))
...
async def keepalive():
    while True:
        ...
        try:
            ...
            print("Error KeepAlive:", e, flush=True)
